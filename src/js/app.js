...
let sTsHeader = document.querySelector('header');
let dDe = document.documentElement;

// let sTsHeight = sTsHeader.offsetHeight;
// dDe.style.setProperty('--header-height', `${sTsHeight}px`);

const sTsObserver = new ResizeObserver(enrties => {
  let sTsHeight = enrties[0].target.offsetHeight;
  dDe.style.setProperty('--header-height', `${sTsHeight}px`);
});

sTsObserver.observe(sTsHeader);